...
def load_config(config_path: str, font_category_override: Optional[str] = None) -> RenderConfig:
    ...
    caption_templates_L4_path_raw = raw.get("caption_templates_L4_path")
    caption_templates_L4_path: Optional[str]
    if caption_templates_L4_path_raw is None:
        caption_templates_L4_path = None
    else:
        if not isinstance(caption_templates_L4_path_raw, str):
            raise ValueError("caption_templates_L4_path must be a string when provided.")
